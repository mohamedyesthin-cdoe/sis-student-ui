"""exam module initiated

Revision ID: 81cd0c2b996e
Revises: 0d1d9a7b8288
Create Date: 2026-02-09 11:01:20.392469
...
revision: str = '81cd0c2b996e'
down_revision: Union[str, None] = '0d1d9a7b8288'
...
def upgrade() -> None:
    ...
    op.alter_column('exams', 'semester_id',
               existing_type=sa.INTEGER(),
               nullable=False)
    op.create_foreign_key(None, 'exams', 'semesters', ['semester_id'], ['id'])
