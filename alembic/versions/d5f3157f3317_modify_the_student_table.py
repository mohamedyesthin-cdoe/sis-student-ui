...
Revision ID: d5f3157f3317
Revises: 9f360e906a9b
Create Date: 2026-02-12 13:35:59.810580
...
revision: str = 'd5f3157f3317'
down_revision: Union[str, None] = '9f360e906a9b'
...
def upgrade() -> None:
    ...
    op.add_column('students', sa.Column('semester_id', sa.Integer(), nullable=True))
