"""change the student table

Revision ID: 50115b9af575
Revises: 4d69d24ad0e3
Create Date: 2026-03-10 23:18:45.056027
...
def upgrade() -> None:
    ...
    op.drop_constraint(op.f('students_semester_id_fkey'), 'students', type_='foreignkey')
...
def downgrade() -> None:
    """Downgrade schema."""
    # ### commands auto generated by Alembic - please adjust! ###
    op.create_foreign_key(op.f('students_semester_id_fkey'), 'students', 'semesters', ['semester_id'], ['id'])
