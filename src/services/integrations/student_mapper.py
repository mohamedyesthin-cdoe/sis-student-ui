...
def map_api_to_student_schema(api_response: dict) -> Dict[str, Any]:
    mapped_data = {
        ...
        "registration_no": "",
        "title": get_first_id(api_response.get("applicant_title")),
        "first_name": api_response.get("first_name", ""),
        "last_name": api_response.get("last_name", ""),
        "gender": get_first_id(api_response.get("gender")),
        "date_of_birth": timestamp_to_date(api_response.get("date_of_birth")),
        "blood_group": get_first_id(api_response.get("blood_group")),
        ...
        "marital_status": get_first_id(api_response.get("marital_status")),
        "religion": get_first_id(api_response.get("religion")),
        "nationality": get_first_country(api_response.get("nationality")),
        "category": get_first_id(api_response.get("category")),
        ...
        "relationship_with_student": get_first_id(api_response.get("field_73698")),
        "current_employment": get_first_id(api_response.get("field_73700")),
        "annual_income": get_first_id(api_response.get("field_73440")),
        "locality": get_first_id(api_response.get("field_77021")),
        ...
        "passport_issued_country": get_first_id(api_response.get("passport_issue_place")),
        "is_deleted": False,

        "address_details": {
            "corr_addr1": api_response.get("correspondence_address1", ""),
            "corr_addr2": api_response.get("correspondence_address2") or None,
            "corr_city": get_first_id(api_response.get("correspondence_city")),
            "corr_district": get_first_id(api_response.get("correspondence_district")),
            "corr_state": get_first_id(api_response.get("correspondence_state")),
            ...
            "perm_city": get_first_id(api_response.get("permanent_city")),
            "perm_district": get_first_id(api_response.get("permanent_district")),
            "perm_state": get_first_id(api_response.get("permanent_state")),
