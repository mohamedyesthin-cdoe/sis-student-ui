...
import { Box, Divider, FormControl, Grid, IconButton, MenuItem, Select, Typography } from "@mui/material";
...
import { FaclitiesData, FeesData, NoticePeriodData, QuickLinksData } from "../../admin/dashboard/cardData";
import { StudentEventData } from "../../admin/dashboard/cardData";
